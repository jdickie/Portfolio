<?php 
	...
	$count=1;$i=0;
	if(!is_numeric ($swift_opt['swift_full_posts_number']) ||$swift_opt['swift_full_posts_number']==0)  echo '<div  id="mag-wrapper" style="width: 590px;position: relative;
    left: -5px;">';
	...
	if ( have_posts() ) : while ( have_posts() ) : the_post();
		...
		if (!in_array(get_the_ID(),$do_not_duplicate)):
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    			...
    			<?php if($i==$swift_opt['swift_full_posts_number']) echo '<div class="fullpost-margin"></div><div  id="mag-wrapper" style="width:590px;position: relative;left: -5px;">';?>
